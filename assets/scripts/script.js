...
function loadScripts(doc, tag) {
    ...
    createElem(doc, tag, 'assets/scripts/module-search-index.js');
    createElem(doc, tag, 'assets/scripts/package-search-index.js');
    createElem(doc, tag, 'assets/scripts/search-page.js');
    createElem(doc, tag, 'assets/scripts/type-search-index.js');
    createElem(doc, tag, 'assets/scripts/member-search-index.js');
    createElem(doc, tag, 'assets/scripts/tag-search-index.js');
    createElem(doc, tag, 'assets/scripts/jquery-3.7.1.min.js');
    createElem(doc, tag, 'assets/scripts/jquery-ui.min.js');
}
